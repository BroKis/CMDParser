...
namespace args_types
{
	...
	{
		std::cout << "Name of argument:" << getLongName() << ".Parameter:" << argument << std::endl;
	}
	...
	{
		std::cout << "Name of argument:" << getLongName() << ".Parameter:" << utils::Utils::boolToString(argument) << std::endl;
	}
	...
	{
		std::cout << "Name of argument:" << getLongName() << ".Parameters:";
	...
	void MultiBoolArg::showHelp() const
	{
		...
		for (const auto& arg : arguments)
		{
			std::cout << utils::Utils::boolToString(arg) << " ";
		}
	}
